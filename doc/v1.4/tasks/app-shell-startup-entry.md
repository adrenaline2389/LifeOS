...
让用户从启动面板进入财务管理系统，同时保持个人生态系统和能量管理系统可进入、其他三个系统后续开放。

## 最小可执行任务

点击财务管理系统入口进入财务管理系统页面；从财务管理系统可以返回启动面板；财务管理系统被推荐时，推荐卡片进入同一页面。
...
- [x] App Shell 新增财务管理系统页面模式。
- [x] Startup Dashboard 支持点击财务管理系统入口。
- [x] 财务管理系统被推荐时，推荐卡片进入同一页面。
- [x] 个人生态系统入口仍进入个人生态系统页面。
- [x] 能量管理系统入口仍进入能量管理系统页面。
- [x] 认知管理系统仍显示后续开放反馈。
- [x] 人生目标管理系统仍显示后续开放反馈。
- [x] 人际关系管理系统仍显示后续开放反馈。
- [x] 财务管理系统页面可以返回启动面板。
